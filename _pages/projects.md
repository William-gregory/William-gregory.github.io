...
<span style="font-size: 16px;">In a followup research resource paper (in review at *Science Advances*) we show that the above sea ice bias correction approach is stable in a continuous 7-year integration with SPEAR.</span>

<img src="http://William-gregory.github.io/images/SPEAR_7yr.png" alt="SciAdv2" width="40%"/>
