...
I am currently a Marie Skłodowska-Curie Actions (MSCA) postdoctoral fellow at University College London (UCL). Here, my work focuses on using AI to develop next-generation coupled climate model emulators and hybrid physics-AI sea ice models. Prior to this, I was a postdoctoral research associate at Princeton University, hired through the [M$^2$LInES](https://m2lines.github.io) initiative. In 2021, I obtained my PhD in polar climate and machine learning from UCL. For more information on my research activities, you can check out my [Google Scholar](https://scholar.google.com/citations?user=zgcx9eQAAAAJ&hl=en&oi=sra).
